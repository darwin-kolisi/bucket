...
export default function AuthLandingPage() {
  return (
    <AuthLayout>
      <main className="relative min-h-[100dvh] bg-white md:bg-gray-50">
        <section className="relative px-6 py-0 md:px-10 flex items-center min-h-[100dvh]">
          <div className="mx-auto max-w-6xl w-full">
            <div className="grid gap-6 md:gap-10 md:grid-cols-[140px_1fr] items-start">
              ...
              <section className="relative mx-auto md:max-w-xl w-full md:rounded-lg md:border md:border-gray-200 bg-white p-6 md:p-8 md:shadow-sm dark:border-[#2f2f2f] dark:shadow-none">
                ...
                <nav className="mt-6 space-y-2" aria-label="Get started">
                  <Link href="/auth/signup" className="group w-full flex items-center gap-3 rounded-md border border-gray-200 bg-white px-4 py-2.5 text-sm font-normal text-gray-900 transition hover:bg-gray-50 hover:border-gray-200">
                  ...
                  <Link href="/auth/signin" className="group w-full flex items-center gap-3 rounded-md border border-gray-200 bg-white px-4 py-2.5 text-sm font-normal text-gray-900 transition hover:bg-gray-50 hover:border-gray-200">
                    <span className="flex h-5 w-5 items-center justify-center">
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
