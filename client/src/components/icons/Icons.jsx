...
export function ListIcon({ className = 'h-4 w-4' }) {
  return (
    <svg
      ...
      aria-hidden="true">
      <path d="M8.25 6.75h11.25M8.25 12h11.25M8.25 17.25h11.25M4.5 6.75h.007v.008H4.5V6.75Zm0 5.25h.007v.008H4.5V12Zm0 5.25h.007v.008H4.5v-.008Z" />
    </svg>
  );
}
...
export function ClockIcon({ className = 'h-4 w-4' }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
      aria-hidden="true">
      <path d="M12 6v6h4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
  );
}

export function EllipsisVerticalIcon({ className = 'h-4 w-4' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function StatusInProgressIcon({ className = 'h-3.5 w-3.5' }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function StatusOnTrackIcon({ className = 'h-3.5 w-3.5' }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function StatusAtRiskIcon({ className = 'h-3.5 w-3.5' }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function StatusCompletedIcon({ className = 'h-3.5 w-3.5' }) {
  return (
    <svg
      className={className}
      fill="none"
